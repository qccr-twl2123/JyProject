...
<html>
    ...
    <body>
     ...
     <form action="zhihui_withdraw_approval/listBank.do" name="Form" id="Form" method="post">
        <input type="hidden" name="pay_status" value="3" />
     	<input type="hidden" name="chuli_ok" value="0" />
     	<input type="hidden" name="remittance_type" value="1" />
       ...
       $(".setAll").click(function() {
		...
		//查询提交
			...
			function daochuexcel(){
					...
					//导出excel
		 			window.location.href='<%=basePath%>zhihuiWaterRecordController/Bankexcel.do?allwaterrecord_id='+allwaterrecord_id;
 			}	
