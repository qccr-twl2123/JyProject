...
<html>
    ...
    <c:if test="${qx.look eq '1'}">
    	<form action="youxuan/youxuancsgl.do" name="Form" id="Form" method="post">
	              	...
	              	<tr>
		                ...
		                <td class="blue bctitle">
			                <c:if test="${qx.edit eq '1'}">
			                	<a class="middle_a" href="youxuan/gocsglEdit.do?city_file_id=${var.city_file_id}&currentPage=${page.currentPage}"  target="ifra">设置优选参数</a>
			                </c:if>
 		                </td>
 		             </tr> 
 	              </c:forEach>           
