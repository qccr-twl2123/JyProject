...
<header>
    <div class="head_cont">
        <img src="img/page/integration.png" alt="" class="logo">
        <div class="title">•  积分设置 </div>
        <p class="help-block font col-xs-5">注：商家根据自身经营状况五选一</p>
    </div>
</header>
<section>
    <div class="sec">
        <div class="nav_tit">
         ...
         <div class="nav_cont zd">   <!--整店送积分设置-->
			...
			<div class="button_box">
				<div class="butt" onclick="onesave('one')">确定</div>
			</div>
		</div>
        ...
        <p class="nav_dec">
            声明： <span>按照类别金额X整店积分率</span>的方式进行积分返还
        </p>
        <p class="nav_dec">
        ...
        <div class="button_box">
            <div class="butt" onclick="twosure('two')">确定</div>
        </div>
    </div>
	<script type="text/javascript">
        ...
        <p class="tips lh">
         ...
         <p class="tips">提醒：您正在切换积分设置，切换后原有设置立即失效。同时部分功能将无法使用，请谨慎选择。</p>
        <div class="button_box">
            <div class="butt" onclick="threesave('three')">确定</div>
        </div>
    </div>
	    <script type="text/javascript">
			...
			var grantrule = "积分率："+threeminRate+"-"+threemaxRate+"%";
 			$.ajax({
                ...
                <div class="form-group fm1">
		         ...
		         <p class="tips">提醒：您正在切换积分设置，切换后原有设置立即失效。同时部分功能将无法使用，请谨慎选择。</p>
		        <div class="button_box">
		            <div class="butt" onclick="foursave('four')">确定</div>
		        </div>
    </div>
	    <script type="text/javascript">
        ...
        <p class="tips">
             ...
             <div class="form-group fm1">
				<c:forEach items="${jfList}" var="jfvar" varStatus="vs">
					<div class="col-xs-4">
						...
						<input type="text" class="col-xs-2 money${vs.index+1}"  id="money" value="${jfvar.money}"  style="width:30%;"/>
         ...
         <p class="tips">提醒：您正在切换积分设置，切换后原有设置立即失效。同时部分功能将无法使用，请谨慎选择。</p>
        <div class="button_box">
            <div class="butt" onclick="fivesave('five')">确定</div>
        </div>
    </div>
        <div class="sec_cont ">
        ...
        <p>
            五、为了给商家提供更好的售后服务和增值服务，每笔交易赠送积分额的25%将另行扣除，用于会员拓展、推广和九鱼网服务体系建设；（例：如商家在一笔消费中向会员张三赠送了10积分，则另需赠送10×25%=2.5积分.
        </p>
        <p>
...
<footer>
    <div class="font_cont">
        <div class="button_box">
            <div class="butt" onclick="gonext()" id="gonext" >前往下一步</div>
        </div>
    </div>
</footer>
</div>
...
<script type="text/javascript">
	    ...
	    function gonext(){
	        if("${shezhi}" == "0"){
	            ...
	            window.location.href='<%=basePath%>storepc/goSheZhiOne.do?store_id=${pd.store_id}&jichushezhi=${jichushezhi}';
	        }
	    }
		...
		function shaixin(change_type){
			 window.location.href='<%=basePath%>storepc_marketing/goIntegral.do?store_id=${storepd.store_id}&jichushezhi=${jichushezhi}&change_type='+change_type;
		}
