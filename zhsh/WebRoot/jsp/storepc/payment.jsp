    ...
    <div class="head_cont">
       <img src="img/page/pay/paylogo.png" alt="" class="logo">
        ...
        <div class="timebox">
            ...
            <!-- <span class="reflash"  onclick="overpay()" >已支付，请点击前往</span> -->
        </div>
        <div class="one"></div>
    </div>
</header>
...
<section>
    <div class="sec_cont">
         ...
         <!-- <div class="aftertimebox"><span>续费后到期时间：</span><span class="nowtime"></span></div -->
        <div class="allprice">
	     		...
	     		if($("#choose").is(":checked")){
	        		...
	        		$.ajax({
	    				type:"post",
	    					...
	    					data:"in_jiqi=4&profit_type=9&starttime="+$(".starttime").val()+"&endtime="+$("#endtime").html()+"&next_city_file_fee_id="+$(".city_file_fee_id").val()+"&money="+paymoney+"&pay_way="+channel+"&store_id="+"${storepd.store_id}"+"&store_operator_id="+"${storepd.oprator_id}"+"&url="+url,
	    					dataType:"json",
