						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										<td>${var.OUT_TRADE_NO}</td>
										<td>${var.LOOK_NUMBER}</td>
										<td>${var.SALE_MONEY}</td>
										<td>${var.DISCOUNT_MONEY}</td>
										<td>${var.ACTUAL_MONEY}</td>
										<td>${var.PAY_TYPE}</td>
										...
										<td>${var.ADDRESS_TYPE}</td>
										<td>${var.REMARK}</td>
										<td>${var.CREATETIME}</td>
										<td>${var.ORDER_STATUS}</td>
								<td style="width: 30px;" class="center">
									<div class='hidden-phone visible-desktop btn-group'>
										...
										<c:if test="${QX.edit == 1 }">
											<a   title="编辑" onclick="edit('${var.order_id}');"  class="btn btn-mini btn-info"  ><i class="icon-edit"></i></a>
										</c:if>
										<c:if test="${QX.del == 1 }">
											<a   title="删除" onclick="del('${var.order_id}');"  class="btn btn-mini btn-info"  ><i class="icon-trash"></i> </a>
										</c:if>
										<!--
