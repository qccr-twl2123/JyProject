...
<body>
	<form action="comment/${msg }.do" name="Form" id="Form" method="post">
		...
		<table>
			...
			<tr>
				<td><input type="text" name="issatisfied" id="issatisfied" value="${pd.issatisfied}" maxlength="32" placeholder="这里输入是否满意" title="是否满意"/></td>
			</tr>
			<tr>
				<td><input type="text" name="star_number" id="star_number" value="${pd.star_number}" maxlength="32" placeholder="这里输入评论几颗星" title="评论几颗星"/></td>
			</tr>
			<tr>
				<td><input type="text" name="star_time" id="star_time" value="${pd.star_time}" maxlength="32" placeholder="这里输入评论时间" title="评论时间"/></td>
			</tr>
			<tr>
