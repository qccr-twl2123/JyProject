							...
							<tr>
								...
								<td style="width: 30px;" class="center">
									<div class='hidden-phone visible-desktop btn-group'>
										...
										<c:if test="${QX.edit == 1 }">
											<a   title="编辑" onclick="edit('${var.MEMBER_ID}');"  class="btn btn-mini btn-info"  ><i class="icon-edit"></i></a>
										</c:if>
										<c:if test="${QX.del == 1 }">
											<a   title="删除" onclick="del('${var.MEMBER_ID}');"  class="btn btn-mini btn-info"  ><i class="icon-trash"></i> </a>
										</c:if>
										<!--
