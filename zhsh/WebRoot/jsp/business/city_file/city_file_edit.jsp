...
<body>
	<form action="city_file/${msg }.do" name="Form" id="Form" method="post">
		...
		<table>
			...
			<tr>
				<td><input type="text" name="city_id" id="city_id" value="${pd.city_id}" maxlength="32" placeholder="这里输入市id" title="city_id"/></td>
			</tr>
			<tr>
