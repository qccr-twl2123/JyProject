...
<body>
	<form action="city_marketing/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="city_marketing_id" id="city_marketing_id" value="${pd.city_marketing_id}"/>
		<div id="zhongxin">
		<table>
			<tr>
				<td><input type="text" name="typenumber" id="typenumber" value="${pd.typenumber}" maxlength="32" placeholder="这里输入类型编号" title="类型编号"/></td>
			</tr>
			<tr>
