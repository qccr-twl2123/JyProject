...
<nav class="top">
	<a href="<%=basePath%>html_me/textDesc.do?type=6" class="fr" style="margin-right:5px;">使用规则</a>
...
<div class="hb-list">
 ...
 <p class="hb-gq-footer">没有更多可用劵了丨<a href="<%=basePath%>html_me/listOver.do?member_id=${pd.member_id}" class="blue">查看过期红包></a></p>
 <script type="text/javascript">
 $(function(){
		$.ajax({
				type:"post",
				url:'<%=basePath%>app_member_redpackets/listAllRedPackage.do',
				data:{
