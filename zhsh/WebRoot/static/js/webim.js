...
//				
//				
//				$('<img>').attr({ "src" : "static/img/head/contact_normal.png"}).appendTo(lielem);//头像
//				$('<span>').html(contact.name).appendTo(lielem);//名称
//				$('#contactlistUL').append(lielem);//我的好友
...
//		   $.ajax({
//			    type:"post",
//			    url:'../zhsh/app_member/imgae_urlById.do', 
//			    data:{"id":userName},            
//				dataType:"json",
...
//									chooseContactDivClick(this);
//								});
//								$('<img>').attr("src", data.data.image_url).appendTo(lielem);
//								$('<span>').html(data.data.name).appendTo(lielem);
...
//			chooseContactDivClick(this);
//		});
//		$('<img>').attr("src", "static/img/head/contact_normal.png").appendTo(lielem);
