 ...
 * profit_type的文字说明
 */
public static final String[] storeorderprofit_type =new String[]{"0","商家提现","积分充值","消费收款","用户积分或余额支付的金钱","第三方支付的金额","抢积分红包","返会员积分","发积分红包","首次购买服务","服务续费","返推广积分","人脉推广收益","优选商品编辑费","优选商品上架费","导流收益","导流支出","昨日人脉收益","商品超出限制扣费","退还积分红包"}  ;
