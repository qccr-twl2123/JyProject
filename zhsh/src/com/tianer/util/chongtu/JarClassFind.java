package com.tianer.util.chongtu;  
...
public class JarClassFind {  
    ...
    static public void main(String[] args) {  
         ...
         */  
        String className = "DefaultHttpClientConnectionOperator"; // 要查询的class,要带包名的类名  
        String libPath = "F:/JyProject/zhsh/WebRoot/WEB-INF/lib"; // 所要查找的JAR包的目录  
