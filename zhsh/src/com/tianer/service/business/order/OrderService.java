package com.tianer.service.business.order;
...
public class OrderService {
	...
	*列表(全部)
	*/
	public List<PageData> xxxx(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("LQOrderMapper.listAll", pd);
	}
