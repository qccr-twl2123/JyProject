...
public class Page {
	...
	private String pageStr;		//最终页面显示的底部翻页导航，详细见：getPageStr();--->这个就是封装好的一个string
	private String pageStr2;		//最终页面显示的底部翻页导航，详细见：getPageStr();--->这个就是封装好的一个string
...
//				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"height:30px;width:50px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
...
//			sb.append(" window.parent.jzts();");
		...
		pageStr = sb.toString();//将拼接的换成String
		return pageStr;
	}
...
//			sb.append(" window.parent.jzts();");
		...
		pageStr2 = sb.toString();//将拼接的换成String
		return pageStr2;
	}
