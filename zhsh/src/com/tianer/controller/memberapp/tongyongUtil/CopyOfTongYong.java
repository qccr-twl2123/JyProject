//package com.tianer.controller.app.tongyongUtil;
//
...
//													e2.put("redpackage_id",BaseController.get32UUID());
...
//  	 * pay_sort_type 买单类别：1-总金额，2-分类购买
//  	 * @return
//  	 * 
//  	 */
...
//			 									zkid=marketing_id;
//											  }
//							}else if(zkpd.getString("discount_type").equals("3") && pay_sort_type.equals("1") && appname.equals("member") && allgoods != null){//单品设置
//  											String[] goods=allgoods.split(",");
//  				 	 						double yhmoney=0;
//				 	 						zkcontent=grantrule;
//				 	 						for(int i=0; i<goods.length ;i++){
...
// 								 										if(!promotion_type.equals("0")){//0-无促销，1-满减，2-单品折扣，3-买N件减1
...
////		  		 								double n1=Double.parseDouble(grantrule.substring(grantrule.indexOf("满")+1, grantrule.indexOf("元")));
//		  		 								double n2=0;
...
////		  		 								double n1=Double.parseDouble(grantrule.substring(grantrule.indexOf("满")+1, grantrule.indexOf("元")));
////		  		 								double n2=Double.parseDouble(grantrule.substring(grantrule.indexOf("减")+1, grantrule.lastIndexOf("元")));
...
////				   							  String str2=DateUtil.getDay()+" "+sdpd.get("starttime").toString();
// //	 			   							  String str3=DateUtil.getDay()+" "+sdpd.get("endtime").toString();
...
//	   								 if(mnpd != null){
////			   									 String fourachieve_number=mnpd.getString("fourachieve_number");
////				   								 String marketsmall_type=mnpd.getString("marketsmall_type");
////				   								 String fourreduce_number=mnpd.getString("fourreduce_number");
////				   								 String foursend_money=mnpd.getString("foursend_money");
////				   								 String allgoods_id=mnpd.getString("goods_id");
////	 				   							  Date date=new Date();
// //					   							  String nowday=DateUtil.getDay();
////					   							  String starttime=mnpd.get("starttime").toString();
////					   							  String endtime=mnpd.get("endtime").toString();
////					   							  String str2=DateUtil.getDay()+" "+mnpd.get("starttime").toString();
////	 	 			   							  String str3=DateUtil.getDay()+" "+mnpd.get("endtime").toString();
//				   								  long l1=new Date().getTime();
...
//							   								 //满足是这个商品以及数量正确
////						   									 if(allgoods_id.contains(str[i])  && Double.parseDouble(fourachieve_number) < Double.parseDouble(str[1])){
////								   										 	if(marketsmall_type.equals("1")){
////	  									  		 									m+=(Double.parseDouble(str[2])/Double.parseDouble(str[1]))*Double.parseDouble(fourreduce_number);
////	 					   										 	}else{
////	  								  		 									m+= Double.parseDouble(foursend_money);
////	 					   										 	}
////						   									 }
//						   									if(str.length != 3){
//	 			 												continue;
...
////				   								String fiveredpackage_type=ljpd.getString("fiveredpackage_type");
////				   								Date date=new Date();
// //	  				   							String nowday=DateUtil.getDay();
////					   							String starttime=ljpd.get("starttime").toString();
////					   							String endtime=ljpd.get("endtime").toString();
////					   							String str2=DateUtil.getDay()+" "+ljpd.get("starttime").toString();
////	 	 			   							String str3=DateUtil.getDay()+" "+ljpd.get("endtime").toString();
//				   								  long l1=new Date().getTime();
...
//		        	 if(monthpd2 == null){
//		        		 monthpd1.put("sp_file_monthly_id", BaseController.get32UUID());
...
//  		        	 if(monthpd2 == null){
//  		        		 monthpd1.put("clerk_file_monthly_id", BaseController.get32UUID());
...
//  					return new PageData();
//  				}
// 					List<PageData> goodsList=ServiceHelper.getAppGoodsService().listAllGoodsByOrder(pd);
...
// 	 	 					goodspd=ServiceHelper.getYouXuanService().finddetailgg(goodspd);
//	 	 					if(goodspd != null){
//	 	 						e1.put("goods_name", goodspd.getString("goods_name"));
...
//	 			pd.put("phone_bymemeber", ServiceHelper.getAppStoreService().findById(pd).getString("phone_bymemeber"));
//	 			pd.put("address", ServiceHelper.getAppStoreService().findById(pd).getString("address"));
//	 			//付款方式
...
//  	 * 商家帮忙注册会员
//  	 */
//  	public static PageData saveMemberByStore(String recommended,String recommended_type,String phone,String password,String name){
//   		String member_id="jy"+phone+BaseController.get4ZMSZ();
// 		PageData pd = new PageData();
// 		try {
//  			//判断手机号码是否为空
// 			pd.put("phone", phone);
...
//							}
// 						}else if(recommended_type.equals("2")){//会员
//							//魅力值：0-50一星会员 50-99 二星会员 100-199 三星会员 200-499  四星会员 500-999 五星会员 1000-2000 一钻会员
...
//   	 	 		try {
//  	 	 			//注册环信
//  	 				HuanXin.regirstHx(member_id, member_id, phone);
//  	  			} catch (Exception e) {
//  	 				// TODO: handle exception
...
//  	 * @return
//  	 */
//  	public static synchronized Map<String,Object>  getJfRedstatic(PageData pd){
//  		Map<String,Object> map = new HashMap<String,Object>();
//  		String result="1";
//  		String message="领取成功！"; 
//  		try {
