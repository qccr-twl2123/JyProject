package com.tianer.controller.system.user;
...
import com.tianer.entity.system.Role;
...
import com.tianer.util.GetPinyin;
import com.tianer.util.MD5;
import com.tianer.util.ObjectExcelRead;
...
public class UserController extends BaseController {
	...
	public ModelAndView saveU(PrintWriter out) throws Exception{
		...
		pd.put("SKIN", "default");				//默认皮肤
 		pd.put("PASSWORD", MD5.md5( pd.getString("PASSWORD")));//MD5加密:初始密码
