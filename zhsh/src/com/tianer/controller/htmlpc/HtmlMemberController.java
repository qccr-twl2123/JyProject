	...
	public static Map<String, String> WxPayOrder(String _total_fee,String attach,String body,String out_trade_no) throws Exception{
		Map<String, String> returnmap=new HashMap<String, String>();
   		try {
	    	...
	    	map.put("notify_url", "http://www.jiuyuvip.com/wxback_chat/notify.do");
	     	//JSAPI--公众号支付、NATIVE--原生扫码支付、APP--app支付，统一下单接口trade_type的传参可参考这里
	    	//MICROPAY--刷卡支付，刷卡支付有单独的支付接口，不调用统一下单接口
	    	map.put("trade_type", "JSAPI");
	    	map.put("openid", ServiceHelper.getAppMemberService().findMemberThreeById(pd).getString("wxopen_id"));
	    	//补全信息
