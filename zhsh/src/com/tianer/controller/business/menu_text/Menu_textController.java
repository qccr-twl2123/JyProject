package com.tianer.controller.business.menu_text;
 ...
 */
@Controller
@RequestMapping(value="/menu_text")
public class Menu_textController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("MENU_TEXT_ID", this.get32UUID());	//主键
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			this.getHC(); //调用权限
			mv.setViewName("business/menu_text/menu_text_list");
