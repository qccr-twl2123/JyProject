package com.tianer.controller.business.app_advert;
 ...
 */
@Controller
@RequestMapping(value="/app_advert")
public class App_advertController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("APP_ADVERT_ID", this.get32UUID());	//主键
	...
	public void delete(PrintWriter out){
		logBefore(logger, "删除App_advert");
		PageData pd = new PageData();
		try{
			pd = this.getPageData();
			app_advertService.delete(pd);
			out.write("success");
			out.close();
		} catch(Exception e){
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			this.getHC(); //调用权限
			mv.setViewName("business/app_advert/app_advert_list");
