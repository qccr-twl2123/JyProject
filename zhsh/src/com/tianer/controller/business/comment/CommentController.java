package com.tianer.controller.business.comment;
...
import com.tianer.service.business.comment.CommentService;
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var3", varOList.get(i).getString("ISSATISFIED"));	//3
				vpd.put("var4", varOList.get(i).getString("STAR_NUMBER"));	//4
				vpd.put("var5", varOList.get(i).getString("STAR_TIME"));	//5
				vpd.put("var6", varOList.get(i).getString("MEMBER_ID"));	//6
				varList.add(vpd);
			}
